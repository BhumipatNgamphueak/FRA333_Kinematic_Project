...
: ${AMENT_CURRENT_PREFIX:="/home/oat/Desktop/FRA333_Kinematic_Project/install/hexapod_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_description/environment/pythonpath.sh"
